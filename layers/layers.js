...
//ol.proj.get("EPSG:4326").setExtent([110.221988, -7.918496, 110.250984, -7.902575]);
var wms_layers = [];
...
var format_CakrukPosRonda_5 = new ol.format.GeoJSON();
var features_CakrukPosRonda_5 = format_CakrukPosRonda_5.readFeatures(json_CakrukPosRonda_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_CakrukPosRonda_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CakrukPosRonda_5.addFeatures(features_CakrukPosRonda_5);
var lyr_CakrukPosRonda_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CakrukPosRonda_5, 
                style: style_CakrukPosRonda_5,
                popuplayertitle: "Cakruk Pos Ronda",
                interactive: true,
                title: '<img src="styles/legend/CakrukPosRonda_5.png" /> Cakruk Pos Ronda'
            });
var format_tag_lokasi_6 = new ol.format.GeoJSON();
var features_tag_lokasi_6 = format_tag_lokasi_6.readFeatures(json_tag_lokasi_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_tag_lokasi_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tag_lokasi_6.addFeatures(features_tag_lokasi_6);
var lyr_tag_lokasi_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_tag_lokasi_6, 
                style: style_tag_lokasi_6,
                popuplayertitle: "tag_lokasi",
                interactive: true,
                title: '<img src="styles/legend/tag_lokasi_6.png" /> tag_lokasi'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_Dusun_Sidorejo2_1.setVisible(true);lyr_RT_Tubin_2.setVisible(true);lyr_jalan_tubin2_3.setVisible(true);lyr_tambahan_rumah_tubin_basis_gmap_4.setVisible(true);lyr_CakrukPosRonda_5.setVisible(true);lyr_tag_lokasi_6.setVisible(true);lyr_Clipped_7.setVisible(true);lyr_titikTempatIbadah_8.setVisible(true);lyr_LapanganVoli_9.setVisible(true);lyr_titikPendidikan_10.setVisible(true);lyr_rumahDukuh_11.setVisible(true);lyr_gedungSeni_12.setVisible(true);lyr_titikMakam_13.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Dusun_Sidorejo2_1,lyr_RT_Tubin_2,lyr_jalan_tubin2_3,lyr_tambahan_rumah_tubin_basis_gmap_4,lyr_CakrukPosRonda_5,lyr_tag_lokasi_6,lyr_Clipped_7,lyr_titikTempatIbadah_8,lyr_LapanganVoli_9,lyr_titikPendidikan_10,lyr_rumahDukuh_11,lyr_gedungSeni_12,lyr_titikMakam_13];
...
lyr_CakrukPosRonda_5.set('fieldAliases', {'nama': 'nama', });
lyr_tag_lokasi_6.set('fieldAliases', {'Nama_lokas': 'Nama_lokas', });
lyr_Clipped_7.set('fieldAliases', {'fid': 'fid', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'addr_stree': 'addr_stree', 'building': 'building', 'addr_house': 'addr_house', 'roof_mater': 'roof_mater', 'building_m': 'building_m', 'access_roo': 'access_roo', 'name': 'name', });
...
lyr_CakrukPosRonda_5.set('fieldImages', {'nama': 'TextEdit', });
lyr_tag_lokasi_6.set('fieldImages', {'Nama_lokas': 'TextEdit', });
lyr_Clipped_7.set('fieldImages', {'fid': '', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'addr_stree': 'TextEdit', 'building': 'TextEdit', 'addr_house': 'TextEdit', 'roof_mater': 'TextEdit', 'building_m': 'TextEdit', 'access_roo': 'TextEdit', 'name': 'TextEdit', });
...
lyr_CakrukPosRonda_5.set('fieldLabels', {'nama': 'no label', });
lyr_tag_lokasi_6.set('fieldLabels', {'Nama_lokas': 'no label', });
lyr_Clipped_7.set('fieldLabels', {'fid': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'addr_stree': 'no label', 'building': 'no label', 'addr_house': 'no label', 'roof_mater': 'no label', 'building_m': 'no label', 'access_roo': 'no label', 'name': 'no label', });
